...
import { buildMetadata, metadatas, callsClientBuilder } from "../index"
...
async function main(): Promise<void> {
    ...
    // prepare batch calls
    const call1 = pangolin2.session.setKeysCall({ aura: "0xd43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d" }, "0x");
    const call2 = pangolin2.staking.collectCall({ commission: 12345 });

    // run batch calls
    // expect call data: 0x1502080900d43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d00080339300000
    await pangolin2.utility.batchAll(wallet, [
        call1,
        call2
    ]);
}
