 ...
 * 
 * `Treasury`'s storages: {@link: module:crab/treasury/storages}
 *
 * @module crab/treasury/calls
 */
...
export const getTreasury = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: crab/treasury/calls/proposeSpend}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: crab/treasury/calls/rejectProposal}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/treasury/calls/approveProposal}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/treasury/calls/spend}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/treasury/calls/removeApproval}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
