 ...
 * 
 * `TechnicalCommittee`'s storages: {@link: module:crab/technicalCommittee/storages}
 *
 * @module crab/technicalCommittee/calls
 */
import { buildRuntimeCall, Dispatch, decodeCall } from "../../../index";
import { ethers, BytesLike } from "ethers";
import { Metadata } from "@polkadot/types";

export const getTechnicalCommittee = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        /**
        ...
        /**
         * Similar to {@link: crab/technicalCommittee/calls/setMembers}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: crab/technicalCommittee/calls/execute}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/technicalCommittee/calls/propose}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/technicalCommittee/calls/vote}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        closeOldWeight: async (signer: ethers.Signer, _proposal_hash: unknown, _index: unknown, _proposal_weight_bound: unknown, _length_bound: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'TechnicalCommittee', 'closeOldWeight', false, {
        ...
        /**
         * Similar to {@link: crab/technicalCommittee/calls/closeOldWeight}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        closeOldWeightH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'TechnicalCommittee', 'closeOldWeight', true, argsBytes);
        },
        ...
        buildCloseOldWeightCall: (_proposal_hash: unknown, _index: unknown, _proposal_weight_bound: unknown, _length_bound: unknown) => {
            return buildRuntimeCall(metadata, 'TechnicalCommittee', 'closeOldWeight', {
                proposal_hash: _proposal_hash,
                index: _index,
                proposal_weight_bound: _proposal_weight_bound,
                length_bound: _length_bound,
        ...
        buildCloseOldWeightCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'TechnicalCommittee', 'closeOldWeight', argsBytes)
        },
        ...
        /**
         * Similar to {@link: crab/technicalCommittee/calls/disapproveProposal}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/technicalCommittee/calls/close}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
