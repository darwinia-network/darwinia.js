 ...
 * 
 * `XcmpQueue`'s storages: {@link: module:crab/xcmpQueue/storages}
 *
 * @module crab/xcmpQueue/calls
 */
...
export const getXcmpQueue = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: crab/xcmpQueue/calls/serviceOverweight}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: crab/xcmpQueue/calls/suspendXcmExecution}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/xcmpQueue/calls/resumeXcmExecution}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/xcmpQueue/calls/updateSuspendThreshold}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/xcmpQueue/calls/updateDropThreshold}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/xcmpQueue/calls/updateResumeThreshold}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/xcmpQueue/calls/updateThresholdWeight}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/xcmpQueue/calls/updateWeightRestrictDecay}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/xcmpQueue/calls/updateXcmpMaxIndividualWeight}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
