/**
 * This is the doc comment for pallet `BridgePolkadotGrandpa`'s calls. 
 * 
 * `BridgePolkadotGrandpa`'s storages: {@link: module:crab/bridgePolkadotGrandpa/storages}
 *
 * @module crab/bridgePolkadotGrandpa/calls
 */
import { buildRuntimeCall, Dispatch, decodeCall } from "../../../index";
import { ethers, BytesLike } from "ethers";
import { Metadata } from "@polkadot/types";

export const getBridgePolkadotGrandpa = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        /**
        ...
        /**
         * Similar to {@link: crab/bridgePolkadotGrandpa/calls/submitFinalityProof}, but with scale encoded args.
         *
        ...
        buildSubmitFinalityProofCall: (_finality_target: unknown, _justification: unknown) => {
            return buildRuntimeCall(metadata, 'BridgePolkadotGrandpa', 'submitFinalityProof', {
                finality_target: _finality_target,
                justification: _justification,
            });
        },
        ...
        buildSubmitFinalityProofCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'BridgePolkadotGrandpa', 'submitFinalityProof', argsBytes)
        },
        ...
        /**
         * Similar to {@link: crab/bridgePolkadotGrandpa/calls/initialize}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        buildInitializeCall: (_init_data: unknown) => {
            return buildRuntimeCall(metadata, 'BridgePolkadotGrandpa', 'initialize', {
                init_data: _init_data,
            });
        },
        ...
        buildInitializeCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'BridgePolkadotGrandpa', 'initialize', argsBytes)
        },
        ...
        /**
         * Similar to {@link: crab/bridgePolkadotGrandpa/calls/setOwner}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        buildSetOwnerCall: (_new_owner: unknown) => {
            return buildRuntimeCall(metadata, 'BridgePolkadotGrandpa', 'setOwner', {
                new_owner: _new_owner,
            });
        },
        ...
        buildSetOwnerCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'BridgePolkadotGrandpa', 'setOwner', argsBytes)
        },
        ...
        setOperatingMode: async (signer: ethers.Signer, _operating_mode: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgePolkadotGrandpa', 'setOperatingMode', false, {
                operating_mode: _operating_mode,
           });
        },

        /**
         * Similar to {@link: crab/bridgePolkadotGrandpa/calls/setOperatingMode}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        setOperatingModeH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgePolkadotGrandpa', 'setOperatingMode', true, argsBytes);
        },
        ...
        buildSetOperatingModeCall: (_operating_mode: unknown) => {
            return buildRuntimeCall(metadata, 'BridgePolkadotGrandpa', 'setOperatingMode', {
                operating_mode: _operating_mode,
            });
        },
        ...
        buildSetOperatingModeCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'BridgePolkadotGrandpa', 'setOperatingMode', argsBytes)
        },
