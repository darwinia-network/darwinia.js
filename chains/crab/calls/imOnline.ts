 ...
 * 
 * `ImOnline`'s storages: {@link: module:crab/imOnline/storages}
 *
 * @module crab/imOnline/calls
 */
...
export const getImOnline = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
	 * Similar to {@link: crab/imOnline/calls/heartbeat}, but with scale encoded args.
	 *
