 ...
 * 
 * `Democracy`'s storages: {@link: module:crab/democracy/storages}
 *
 * @module crab/democracy/calls
 */
...
export const getDemocracy = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: crab/democracy/calls/propose}, but with scale encoded args.
         *
         ...
         * @param {unknown} _seconds_upper_bound Compact<U32>
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/second}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/vote}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/emergencyCancel}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/externalPropose}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/externalProposeMajority}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/externalProposeDefault}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/fastTrack}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/vetoExternal}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/cancelReferendum}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/cancelQueued}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildCancelQueuedCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/delegate}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/undelegate}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/clearPublicProposals}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
         ...
         *
         * @param {unknown} _encoded_proposal Vec<U8>
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/notePreimage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/notePreimageOperational}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildNotePreimageOperationalCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/noteImminentPreimage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildNoteImminentPreimageCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/noteImminentPreimageOperational}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildNoteImminentPreimageOperationalCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
         ...
         *
         * @param {unknown} _proposal_hash [U8; 32]
         * @param {unknown} _proposal_len_upper_bound Compact<U32>
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/reapPreimage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildReapPreimageCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/unlock}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/removeVote}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/removeOtherVote}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/enactProposal}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildEnactProposalCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/blacklist}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/democracy/calls/cancelProposal}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
