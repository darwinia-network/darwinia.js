 ...
 * 
 * `MessageGadget`'s storages: {@link: module:crab/messageGadget/storages}
 *
 * @module crab/messageGadget/calls
 */
...
export const getMessageGadget = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: crab/messageGadget/calls/setCommitmentContract}, but with scale encoded args.
         *
