 ...
 * 
 * `TxPause`'s storages: {@link: module:crab/txPause/storages}
 *
 * @module crab/txPause/calls
 */
...
export const getTxPause = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: crab/txPause/calls/pause}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: crab/txPause/calls/unpause}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
