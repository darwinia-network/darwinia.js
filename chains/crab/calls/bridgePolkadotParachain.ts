 ...
 * 
 * `BridgePolkadotParachain`'s storages: {@link: module:crab/bridgePolkadotParachain/storages}
 *
 * @module crab/bridgePolkadotParachain/calls
 */
...
export const getBridgePolkadotParachain = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: crab/bridgePolkadotParachain/calls/submitParachainHeads}, but with scale encoded args.
         *
        ...
        setOwner: async (signer: ethers.Signer, _new_owner: unknown): Promise<ethers.providers.TransactionResponse> => {
            return await dispatch(signer, 'BridgePolkadotParachain', 'setOwner', false, {
                new_owner: _new_owner,
           });
        },

        /**
         * Similar to {@link: crab/bridgePolkadotParachain/calls/setOwner}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        setOwnerH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionResponse> => {
            return await dispatch(signer, 'BridgePolkadotParachain', 'setOwner', true, argsBytes);
        },
        ...
        buildSetOwnerCall: (_new_owner: unknown) => {
            return buildRuntimeCall(metadata, 'BridgePolkadotParachain', 'setOwner', {
                new_owner: _new_owner,
            });
        },
        ...
        buildSetOwnerCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'BridgePolkadotParachain', 'setOwner', argsBytes)
        },
        ...
        setOperatingMode: async (signer: ethers.Signer, _operating_mode: unknown): Promise<ethers.providers.TransactionResponse> => {
            return await dispatch(signer, 'BridgePolkadotParachain', 'setOperatingMode', false, {
                operating_mode: _operating_mode,
           });
        },

        /**
         * Similar to {@link: crab/bridgePolkadotParachain/calls/setOperatingMode}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        setOperatingModeH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionResponse> => {
            return await dispatch(signer, 'BridgePolkadotParachain', 'setOperatingMode', true, argsBytes);
        },
        ...
        buildSetOperatingModeCall: (_operating_mode: unknown) => {
            return buildRuntimeCall(metadata, 'BridgePolkadotParachain', 'setOperatingMode', {
                operating_mode: _operating_mode,
            });
        },
        ...
        buildSetOperatingModeCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'BridgePolkadotParachain', 'setOperatingMode', argsBytes)
        },
