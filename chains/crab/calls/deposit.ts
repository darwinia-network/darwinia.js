 ...
 * 
 * `Deposit`'s storages: {@link: module:crab/deposit/storages}
 *
 * @module crab/deposit/calls
 */
...
export const getDeposit = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: crab/deposit/calls/lock}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: crab/deposit/calls/claim}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/deposit/calls/claimWithPenalty}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
