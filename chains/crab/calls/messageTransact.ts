 ...
 * 
 * `MessageTransact`'s storages: {@link: module:crab/messageTransact/storages}
 *
 * @module crab/messageTransact/calls
 */
...
export const getMessageTransact = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: crab/messageTransact/calls/messageTransact}, but with scale encoded args.
         *
