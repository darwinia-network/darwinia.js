 ...
 * 
 * `PhragmenElection`'s storages: {@link: module:crab/phragmenElection/storages}
 *
 * @module crab/phragmenElection/calls
 */
...
export const getPhragmenElection = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: crab/phragmenElection/calls/vote}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: crab/phragmenElection/calls/removeVoter}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/phragmenElection/calls/submitCandidacy}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/phragmenElection/calls/renounceCandidacy}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/phragmenElection/calls/removeMember}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/phragmenElection/calls/cleanDefunctVoters}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
