 ...
 * 
 * `EcdsaAuthority`'s storages: {@link: module:crab/ecdsaAuthority/storages}
 *
 * @module crab/ecdsaAuthority/calls
 */
...
export const getEcdsaAuthority = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: crab/ecdsaAuthority/calls/addAuthority}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: crab/ecdsaAuthority/calls/removeAuthority}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/ecdsaAuthority/calls/swapAuthority}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/ecdsaAuthority/calls/submitAuthoritiesChangeSignature}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/ecdsaAuthority/calls/submitNewMessageRootSignature}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
