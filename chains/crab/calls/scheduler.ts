 ...
 * 
 * `Scheduler`'s storages: {@link: module:crab/scheduler/storages}
 *
 * @module crab/scheduler/calls
 */
...
export const getScheduler = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: crab/scheduler/calls/schedule}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: crab/scheduler/calls/cancel}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/scheduler/calls/scheduleNamed}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/scheduler/calls/cancelNamed}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/scheduler/calls/scheduleAfter}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: crab/scheduler/calls/scheduleNamedAfter}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
