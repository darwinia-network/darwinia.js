...
/**
 * This is the doc comment for pallet `DarwiniaFeeMarket`'s storages.
 * 
 * `DarwiniaFeeMarket`'s calls: {@link: module:crab/darwiniaFeeMarket/calls}
 *
 * @module crab/darwiniaFeeMarket/storages
 */
