...
/**
 * This is the doc comment for pallet `BridgePolkadotGrandpa`'s storages.
 * 
 * `BridgePolkadotGrandpa`'s calls: {@link: module:crab/bridgePolkadotGrandpa/calls}
 *
 * @module crab/bridgePolkadotGrandpa/storages
 */
export const getBridgePolkadotGrandpa = (getStorage: GetStorage) => {
    return {
        ...
        palletOperatingMode: async (): Promise<string | null> => {
            return await getStorage('BridgePolkadotGrandpa', 'PalletOperatingMode');
        },
    };
};
