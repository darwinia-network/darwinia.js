...
/**
 * This is the doc comment for pallet `DarwiniaHeaderMmr`'s storages.
 * 
 * `DarwiniaHeaderMmr`'s calls: {@link: module:crab/darwiniaHeaderMmr/calls}
 *
 * @module crab/darwiniaHeaderMmr/storages
 */
