...
export const getIdentity = (getStorage: GetStorage) => {
    return {
        ...
        */
        identityOf: async (param0: unknown /* AccountId32: [U8; 32] */): Promise<string | null> => {
        ...
        */
        superOf: async (param0: unknown /* AccountId32: [U8; 32] */): Promise<string | null> => {
        ...
        * TWOX-NOTE: OK ― `AccountId` is a secure hash.
        */
        subsOf: async (param0: unknown /* AccountId32: [U8; 32] */): Promise<string | null> => {
