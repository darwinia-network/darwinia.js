 ...
 * 
 * `EVM`'s storages: {@link: module:darwinia/evm/storages}
 *
 * @module darwinia/evm/calls
 */
...
export const getEVM = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/evm/calls/withdraw}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: darwinia/evm/calls/call}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/evm/calls/create}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/evm/calls/create2}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
