 ...
 * 
 * `AssetManager`'s storages: {@link: module:darwinia/assetManager/storages}
 *
 * @module darwinia/assetManager/calls
 */
...
export const getAssetManager = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/assetManager/calls/registerForeignAsset}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: darwinia/assetManager/calls/setAssetUnitsPerSecond}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/assetManager/calls/changeExistingAssetType}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/assetManager/calls/removeSupportedAsset}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/assetManager/calls/removeExistingAssetType}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/assetManager/calls/registerLocalAsset}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/assetManager/calls/destroyForeignAsset}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/assetManager/calls/destroyLocalAsset}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
