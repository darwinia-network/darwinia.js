 ...
 * 
 * `AccountMigration`'s storages: {@link: module:darwinia/accountMigration/storages}
 *
 * @module darwinia/accountMigration/calls
 */
...
export const getAccountMigration = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/accountMigration/calls/migrate}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: darwinia/accountMigration/calls/migrateMultisig}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/accountMigration/calls/completeMultisigMigration}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
