 ...
 * 
 * `DmpQueue`'s storages: {@link: module:darwinia/dmpQueue/storages}
 *
 * @module darwinia/dmpQueue/calls
 */
...
export const getDmpQueue = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/dmpQueue/calls/serviceOverweight}, but with scale encoded args.
         *
