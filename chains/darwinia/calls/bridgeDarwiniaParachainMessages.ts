/**
 * This is the doc comment for pallet `BridgeDarwiniaParachainMessages`'s calls. 
 * 
 * `BridgeDarwiniaParachainMessages`'s storages: {@link: module:darwinia/bridgeDarwiniaParachainMessages/storages}
 *
 * @module darwinia/bridgeDarwiniaParachainMessages/calls
 */
...
export const getBridgeDarwiniaParachainMessages = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        setOwner: async (signer: ethers.Signer, _new_owner: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'setOwner', false, {
                new_owner: _new_owner,
           });
        },

        /**
         * Similar to {@link: darwinia/bridgeDarwiniaParachainMessages/calls/setOwner}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        setOwnerH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'setOwner', true, argsBytes);
        },
        ...
        setOperatingMode: async (signer: ethers.Signer, _operating_mode: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'setOperatingMode', false, {
                operating_mode: _operating_mode,
           });
        },

        /**
         * Similar to {@link: darwinia/bridgeDarwiniaParachainMessages/calls/setOperatingMode}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        setOperatingModeH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'setOperatingMode', true, argsBytes);
        },
         ...
         * event.
         *
         * @param {unknown} _parameter Enum<{0/DarwiniaParachainToDarwiniaConversionRate: U128}>
         * @instance
         */
        updatePalletParameter: async (signer: ethers.Signer, _parameter: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'updatePalletParameter', false, {
                parameter: _parameter,
           });
        },

        /**
         * Similar to {@link: darwinia/bridgeDarwiniaParachainMessages/calls/updatePalletParameter}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        updatePalletParameterH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'updatePalletParameter', true, argsBytes);
        },
        ...
        sendMessage: async (signer: ethers.Signer, _lane_id: unknown, _payload: unknown, _delivery_and_dispatch_fee: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'sendMessage', false, {
                lane_id: _lane_id,
                payload: _payload,
        ...
        /**
         * Similar to {@link: darwinia/bridgeDarwiniaParachainMessages/calls/sendMessage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        sendMessageH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'sendMessage', true, argsBytes);
        },
        ...
        increaseMessageFee: async (signer: ethers.Signer, _lane_id: unknown, _nonce: unknown, _additional_fee: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'increaseMessageFee', false, {
                lane_id: _lane_id,
                nonce: _nonce,
        ...
        /**
         * Similar to {@link: darwinia/bridgeDarwiniaParachainMessages/calls/increaseMessageFee}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        increaseMessageFeeH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'increaseMessageFee', true, argsBytes);
        },
        ...
        receiveMessagesProof: async (signer: ethers.Signer, _relayer_id_at_bridged_chain: unknown, _proof: unknown, _messages_count: unknown, _dispatch_weight: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'receiveMessagesProof', false, {
        ...
        /**
         * Similar to {@link: darwinia/bridgeDarwiniaParachainMessages/calls/receiveMessagesProof}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        receiveMessagesProofH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'receiveMessagesProof', true, argsBytes);
        },
        ...
        receiveMessagesDeliveryProof: async (signer: ethers.Signer, _proof: unknown, _relayers_state: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'receiveMessagesDeliveryProof', false, {
                proof: _proof,
        ...
        /**
         * Similar to {@link: darwinia/bridgeDarwiniaParachainMessages/calls/receiveMessagesDeliveryProof}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        receiveMessagesDeliveryProofH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'BridgeDarwiniaParachainMessages', 'receiveMessagesDeliveryProof', true, argsBytes);
        },
