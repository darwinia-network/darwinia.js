 ...
 * 
 * `EthTxForwarder`'s storages: {@link: module:darwinia/ethTxForwarder/storages}
 *
 * @module darwinia/ethTxForwarder/calls
 */
...
export const getEthTxForwarder = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/ethTxForwarder/calls/forwardTransact}, but with scale encoded args.
         *
