 ...
 * 
 * `MessageTransact`'s storages: {@link: module:darwinia/messageTransact/storages}
 *
 * @module darwinia/messageTransact/calls
 */
...
export const getMessageTransact = (dispatch: Dispatch, metadata: Metadata) => {
    return {
         ...
         * @instance
         */
        messageTransact: async (signer: ethers.Signer, _transaction: unknown): Promise<ethers.providers.TransactionResponse> => {
        ...
        /**
         * Similar to {@link: darwinia/messageTransact/calls/messageTransact}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        messageTransactH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionResponse> => {
