 ...
 * 
 * `Grandpa`'s storages: {@link: module:darwinia/grandpa/storages}
 *
 * @module darwinia/grandpa/calls
 */
...
export const getGrandpa = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/grandpa/calls/reportEquivocation}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: darwinia/grandpa/calls/reportEquivocationUnsigned}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/grandpa/calls/noteStalled}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
