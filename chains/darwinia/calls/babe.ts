 ...
 * 
 * `Babe`'s storages: {@link: module:darwinia/babe/storages}
 *
 * @module darwinia/babe/calls
 */
...
export const getBabe = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/babe/calls/reportEquivocation}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: darwinia/babe/calls/reportEquivocationUnsigned}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/babe/calls/planConfigChange}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
