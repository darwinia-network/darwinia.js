 ...
 * 
 * `Whitelist`'s storages: {@link: module:darwinia/whitelist/storages}
 *
 * @module darwinia/whitelist/calls
 */
...
export const getWhitelist = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/whitelist/calls/whitelistCall}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: darwinia/whitelist/calls/removeWhitelistedCall}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/whitelist/calls/dispatchWhitelistedCall}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/whitelist/calls/dispatchWhitelistedCallWithPreimage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
