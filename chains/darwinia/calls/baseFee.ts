 ...
 * 
 * `BaseFee`'s storages: {@link: module:darwinia/baseFee/storages}
 *
 * @module darwinia/baseFee/calls
 */
...
export const getBaseFee = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/baseFee/calls/setBaseFeePerGas}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: darwinia/baseFee/calls/setIsActive}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/baseFee/calls/setElasticity}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
