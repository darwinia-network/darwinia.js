 ...
 * 
 * `AssetLimit`'s storages: {@link: module:darwinia/assetLimit/storages}
 *
 * @module darwinia/assetLimit/calls
 */
...
export const getAssetLimit = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/assetLimit/calls/setForeignAssetLimit}, but with scale encoded args.
         *
