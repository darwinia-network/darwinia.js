 ...
 * 
 * `XcmpQueue`'s storages: {@link: module:darwinia/xcmpQueue/storages}
 *
 * @module darwinia/xcmpQueue/calls
 */
...
export const getXcmpQueue = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/xcmpQueue/calls/serviceOverweight}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: darwinia/xcmpQueue/calls/suspendXcmExecution}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/xcmpQueue/calls/resumeXcmExecution}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/xcmpQueue/calls/updateSuspendThreshold}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/xcmpQueue/calls/updateDropThreshold}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/xcmpQueue/calls/updateResumeThreshold}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/xcmpQueue/calls/updateThresholdWeight}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/xcmpQueue/calls/updateWeightRestrictDecay}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/xcmpQueue/calls/updateXcmpMaxIndividualWeight}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
