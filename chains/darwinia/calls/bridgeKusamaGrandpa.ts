/**
 * This is the doc comment for pallet `BridgeKusamaGrandpa`'s calls. 
 * 
 * `BridgeKusamaGrandpa`'s storages: {@link: module:darwinia/bridgeKusamaGrandpa/storages}
 *
 * @module darwinia/bridgeKusamaGrandpa/calls
 */
...
export const getBridgeKusamaGrandpa = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/bridgeKusamaGrandpa/calls/submitFinalityProof}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: darwinia/bridgeKusamaGrandpa/calls/initialize}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/bridgeKusamaGrandpa/calls/setOwner}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/bridgeKusamaGrandpa/calls/setOperatingMode}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        buildSetOperatingModeCall: (_operating_mode: unknown) => {
            return buildRuntimeCall(metadata, 'BridgeKusamaGrandpa', 'setOperatingMode', {
                operating_mode: _operating_mode,
            });
        },
        ...
        buildSetOperatingModeCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'BridgeKusamaGrandpa', 'setOperatingMode', argsBytes)
        },
