 ...
 * 
 * `ConvictionVoting`'s storages: {@link: module:darwinia/convictionVoting/storages}
 *
 * @module darwinia/convictionVoting/calls
 */
...
export const getConvictionVoting = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/convictionVoting/calls/vote}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: darwinia/convictionVoting/calls/delegate}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/convictionVoting/calls/undelegate}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/convictionVoting/calls/unlock}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/convictionVoting/calls/removeVote}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/convictionVoting/calls/removeOtherVote}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
