 ...
 * 
 * `EcdsaAuthority`'s storages: {@link: module:darwinia/ecdsaAuthority/storages}
 *
...
export const getEcdsaAuthority = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: darwinia/ecdsaAuthority/calls/addAuthority}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: darwinia/ecdsaAuthority/calls/removeAuthority}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/ecdsaAuthority/calls/swapAuthority}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/ecdsaAuthority/calls/submitAuthoritiesChangeSignature}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: darwinia/ecdsaAuthority/calls/submitNewMessageRootSignature}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
