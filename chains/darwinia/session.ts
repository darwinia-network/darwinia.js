...
export const getSession = (getStorage: GetStorage) => {
    return {
        ...
        * @return Vec&lt;([U8; 32], {babe: [U8; 32], grandpa: [U8; 32], im_online: [U8; 32], authority_discovery: [U8; 32]})&gt;
        */
        ...
        * @return SessionKeys: {babe: [U8; 32], grandpa: [U8; 32], im_online: [U8; 32], authority_discovery: [U8; 32]}
        */
