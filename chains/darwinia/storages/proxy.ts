 ...
 * 
 * `Proxy`'s calls: {@link: module:darwinia/proxy/calls}
 *
 * @module darwinia/proxy/storages
 */
export const getProxy = (getStorage: GetStorage) => {
    return {
         ...
         * @returns {Promise<string | null>} (Vec<{delegate: [U8; 20], proxy_type: Enum<{0/Any: , 1/NonTransfer: , 2/Governance: , 3/Staking: , 4/IdentityJudgement: , 5/CancelProxy: , 6/EcdsaBridge: , 7/SubstrateBridge: }>, delay: U32}>, U128)
         */
