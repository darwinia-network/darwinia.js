...
export const getProxy = (getStorage: GetStorage) => {
    return {
         ...
         * @returns {Promise<string | null>} (Vec<{delegate: [U8; 32], proxy_type: Enum<{0/Any: , 1/NonTransfer: , 2/Governance: , 3/Staking: , 4/IdentityJudgement: , 5/EthereumBridge: }>, delay: U32}>, U128)
         */
