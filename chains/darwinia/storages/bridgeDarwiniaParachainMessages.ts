...
/**
 * This is the doc comment for pallet `BridgeDarwiniaParachainMessages`'s storages.
 * 
 * `BridgeDarwiniaParachainMessages`'s calls: {@link: module:darwinia/bridgeDarwiniaParachainMessages/calls}
 *
 * @module darwinia/bridgeDarwiniaParachainMessages/storages
 */
export const getBridgeDarwiniaParachainMessages = (getStorage: GetStorage) => {
    return {
