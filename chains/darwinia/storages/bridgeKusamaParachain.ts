...
/**
 * This is the doc comment for pallet `BridgeKusamaParachain`'s storages.
 * 
 * `BridgeKusamaParachain`'s calls: {@link: module:darwinia/bridgeKusamaParachain/calls}
 *
 * @module darwinia/bridgeKusamaParachain/storages
 */
export const getBridgeKusamaParachain = (getStorage: GetStorage) => {
    return {
        ...
        palletOwner: async (): Promise<string | null> => {
            return await getStorage('BridgeKusamaParachain', 'PalletOwner');
        },
        ...
        palletOperatingMode: async (): Promise<string | null> => {
            return await getStorage('BridgeKusamaParachain', 'PalletOperatingMode');
        },
        ...
        parasInfo: async (param0: unknown): Promise<string | null> => {
            return await getStorage('BridgeKusamaParachain', 'ParasInfo', param0);
        },
