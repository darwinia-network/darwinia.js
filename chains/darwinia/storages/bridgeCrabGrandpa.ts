...
/**
 * This is the doc comment for pallet `BridgeCrabGrandpa`'s storages.
 * 
 * `BridgeCrabGrandpa`'s calls: {@link: module:darwinia/bridgeCrabGrandpa/calls}
 *
 * @module darwinia/bridgeCrabGrandpa/storages
 */
