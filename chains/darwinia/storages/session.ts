 ...
 * 
 * `Session`'s calls: {@link: module:darwinia/session/calls}
 *
 * @module darwinia/session/storages
 */
export const getSession = (getStorage: GetStorage) => {
    return {
         ...
         *
         * @returns {Promise<string | null>} Vec<([U8; 32], {babe: [U8; 32], grandpa: [U8; 32], im_online: [U8; 32], authority_discovery: [U8; 32]})>
         */
         ...
         * @returns {Promise<string | null>} SessionKeys: {babe: [U8; 32], grandpa: [U8; 32], im_online: [U8; 32], authority_discovery: [U8; 32]}
         */
