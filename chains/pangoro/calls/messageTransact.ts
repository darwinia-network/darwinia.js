 ...
 * 
 * `MessageTransact`'s storages: {@link: module:pangoro/messageTransact/storages}
 *
 * @module pangoro/messageTransact/calls
 */
...
export const getMessageTransact = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangoro/messageTransact/calls/messageTransact}, but with scale encoded args.
         *
