 ...
 * 
 * `ElectionProviderMultiPhase`'s storages: {@link: module:pangoro/electionProviderMultiPhase/storages}
 *
 * @module pangoro/electionProviderMultiPhase/calls
 */
...
export const getElectionProviderMultiPhase = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
	 * Similar to {@link: pangoro/electionProviderMultiPhase/calls/submitUnsigned}, but with scale encoded args.
	 *
	 ...
	 */
        ...
        /**
	 * Similar to {@link: pangoro/electionProviderMultiPhase/calls/setMinimumUntrustedScore}, but with scale encoded args.
	 *
	 * @param {BytesLike} argsBytes the args bytes
	 */
	 ...
	 */
        ...
        /**
	 * Similar to {@link: pangoro/electionProviderMultiPhase/calls/setEmergencyElectionResult}, but with scale encoded args.
	 *
	 * @param {BytesLike} argsBytes the args bytes
	 */
	 ...
	 */
        ...
        /**
	 * Similar to {@link: pangoro/electionProviderMultiPhase/calls/submit}, but with scale encoded args.
	 *
	 * @param {BytesLike} argsBytes the args bytes
	 */
