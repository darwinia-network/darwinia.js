 ...
 * 
 * `BaseFee`'s storages: {@link: module:pangoro/baseFee/storages}
 *
 * @module pangoro/baseFee/calls
 */
...
export const getBaseFee = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
	 * Similar to {@link: pangoro/baseFee/calls/setBaseFeePerGas}, but with scale encoded args.
	 *
	 ...
	 */
        ...
        /**
	 * Similar to {@link: pangoro/baseFee/calls/setIsActive}, but with scale encoded args.
	 *
	 * @param {BytesLike} argsBytes the args bytes
	 */
	 ...
	 */
        ...
        /**
	 * Similar to {@link: pangoro/baseFee/calls/setElasticity}, but with scale encoded args.
	 *
	 * @param {BytesLike} argsBytes the args bytes
	 */
