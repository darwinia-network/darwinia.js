 ...
 * 
 * `EthereumXcm`'s storages: {@link: module:pangoro/ethereumXcm/storages}
 *
 * @module pangoro/ethereumXcm/calls
 */
...
export const getEthereumXcm = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangoro/ethereumXcm/calls/transact}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangoro/ethereumXcm/calls/transactThroughProxy}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/ethereumXcm/calls/suspendEthereumXcmExecution}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/ethereumXcm/calls/resumeEthereumXcmExecution}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
