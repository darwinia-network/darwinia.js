 ...
 * 
 * `Babe`'s storages: {@link: module:pangoro/babe/storages}
 *
 * @module pangoro/babe/calls
 */
...
export const getBabe = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
	 * Similar to {@link: pangoro/babe/calls/reportEquivocation}, but with scale encoded args.
	 *
	 ...
	 */
        ...
        /**
	 * Similar to {@link: pangoro/babe/calls/reportEquivocationUnsigned}, but with scale encoded args.
	 *
	 * @param {BytesLike} argsBytes the args bytes
	 */
	 ...
	 */
        ...
        /**
	 * Similar to {@link: pangoro/babe/calls/planConfigChange}, but with scale encoded args.
	 *
	 * @param {BytesLike} argsBytes the args bytes
	 */
