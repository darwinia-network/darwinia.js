 ...
 * 
 * `AccountMigration`'s storages: {@link: module:pangoro/accountMigration/storages}
 *
 * @module pangoro/accountMigration/calls
 */
...
export const getAccountMigration = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangoro/accountMigration/calls/migrate}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangoro/accountMigration/calls/migrateMultisig}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/accountMigration/calls/completeMultisigMigration}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
