 ...
 * 
 * `DmpQueue`'s storages: {@link: module:pangoro/dmpQueue/storages}
 *
 * @module pangoro/dmpQueue/calls
 */
...
export const getDmpQueue = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangoro/dmpQueue/calls/serviceOverweight}, but with scale encoded args.
         *
