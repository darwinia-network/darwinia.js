 ...
 * 
 * `Timestamp`'s storages: {@link: module:pangoro/timestamp/storages}
 *
 * @module pangoro/timestamp/calls
 */
...
export const getTimestamp = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangoro/timestamp/calls/set}, but with scale encoded args.
         *
