 ...
 * 
 * `Tips`'s storages: {@link: module:pangoro/tips/storages}
 *
 * @module pangoro/tips/calls
 */
...
export const getTips = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangoro/tips/calls/reportAwesome}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangoro/tips/calls/retractTip}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/tips/calls/tipNew}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/tips/calls/tip}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/tips/calls/closeTip}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/tips/calls/slashTip}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
