 ...
 * 
 * `Vesting`'s storages: {@link: module:pangoro/vesting/storages}
 *
 * @module pangoro/vesting/calls
 */
...
export const getVesting = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangoro/vesting/calls/vest}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangoro/vesting/calls/vestOther}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/vesting/calls/vestedTransfer}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/vesting/calls/forceVestedTransfer}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/vesting/calls/mergeSchedules}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
