 ...
 * 
 * `ParachainSystem`'s storages: {@link: module:pangoro/parachainSystem/storages}
 *
 * @module pangoro/parachainSystem/calls
 */
...
export const getParachainSystem = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangoro/parachainSystem/calls/setValidationData}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangoro/parachainSystem/calls/sudoSendUpwardMessage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/parachainSystem/calls/authorizeUpgrade}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/parachainSystem/calls/enactAuthorizedUpgrade}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
