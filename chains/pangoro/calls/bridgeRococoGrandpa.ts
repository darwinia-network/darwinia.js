 ...
 * 
 * `BridgeRococoGrandpa`'s storages: {@link: module:pangoro/bridgeRococoGrandpa/storages}
 *
 * @module pangoro/bridgeRococoGrandpa/calls
 */
...
export const getBridgeRococoGrandpa = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangoro/bridgeRococoGrandpa/calls/submitFinalityProof}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangoro/bridgeRococoGrandpa/calls/initialize}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/bridgeRococoGrandpa/calls/setOwner}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/bridgeRococoGrandpa/calls/setOperatingMode}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
