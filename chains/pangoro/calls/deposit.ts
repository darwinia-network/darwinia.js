 ...
 * 
 * `Deposit`'s storages: {@link: module:pangoro/deposit/storages}
 *
 * @module pangoro/deposit/calls
 */
...
export const getDeposit = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangoro/deposit/calls/lock}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangoro/deposit/calls/claim}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangoro/deposit/calls/claimWithPenalty}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
