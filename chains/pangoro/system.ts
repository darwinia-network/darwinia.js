...
export const getSystem = (getStorage: GetStorage) => {
    return {
        ...
        */
        blockHash: async (param0: unknown /* U32 */): Promise<string | null> => {
        ...
        */
        extrinsicData: async (param0: unknown /* U32 */): Promise<string | null> => {
        ...
        */
        eventTopics: async (param0: unknown /* H256: [U8; 32] */): Promise<string | null> => {
