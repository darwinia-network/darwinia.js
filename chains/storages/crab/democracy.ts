...
export const getDemocracy = (getStorage: GetStorage) => {
    return {
        ...
        * @return PreimageStatus: Enum<{Missing: U32, Available: {data: Vec<U8>, provider: [U8; 32], deposit: U128, since: U32, expiry: Enum<{None: , Some: U32}>}}>
        */
