 ...
 * 
 * `Assets`'s calls: {@link: module:pangolin2/assets/calls}
 *
 * @module pangolin2/assets/storages
 */
export const getAssets = (getStorage: GetStorage) => {
    return {
         ...
         * @returns {Promise<string | null>} AssetDetails: {owner: [U8; 20], issuer: [U8; 20], admin: [U8; 20], freezer: [U8; 20], supply: U128, deposit: U128, min_balance: U128, is_sufficient: Bool, accounts: U32, sufficients: U32, approvals: U32, is_frozen: Bool}
         */
