...
export const getSystem = (getStorage: GetStorage) => {
    return {
         ...
         *
         * @return PerDispatchClass: {normal: {ref_time: Compact<U64>, proof_size: Compact<U64>}, operational: {ref_time: Compact<U64>, proof_size: Compact<U64>}, mandatory: {ref_time: Compact<U64>, proof_size: Compact<U64>}}
         */
