 ...
 * 
 * `MessageGadget`'s storages: {@link: module:pangolin2/messageGadget/storages}
 *
 * @module pangolin2/messageGadget/calls
 */
...
export const getMessageGadget = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin2/messageGadget/calls/setCommitmentContract}, but with scale encoded args.
         *
