 ...
 * 
 * `TechnicalMembership`'s storages: {@link: module:pangolin2/technicalMembership/storages}
 *
 * @module pangolin2/technicalMembership/calls
 */
...
export const getTechnicalMembership = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin2/technicalMembership/calls/addMember}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangolin2/technicalMembership/calls/removeMember}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin2/technicalMembership/calls/swapMember}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin2/technicalMembership/calls/resetMembers}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin2/technicalMembership/calls/changeKey}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin2/technicalMembership/calls/setPrime}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin2/technicalMembership/calls/clearPrime}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
