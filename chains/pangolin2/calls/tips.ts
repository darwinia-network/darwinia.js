 ...
 * 
 * `Tips`'s storages: {@link: module:pangolin2/tips/storages}
 *
 * @module pangolin2/tips/calls
 */
...
export const getTips = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin2/tips/calls/reportAwesome}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangolin2/tips/calls/retractTip}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin2/tips/calls/tipNew}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin2/tips/calls/tip}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin2/tips/calls/closeTip}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin2/tips/calls/slashTip}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
