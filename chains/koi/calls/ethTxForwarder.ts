 ...
 * 
 * `EthTxForwarder`'s storages: {@link: module:koi/ethTxForwarder/storages}
 *
 * @module koi/ethTxForwarder/calls
 */
...
export const getEthTxForwarder = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/ethTxForwarder/calls/forwardTransact}, but with scale encoded args.
         *
