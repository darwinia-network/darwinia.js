 ...
 * 
 * `DmpQueue`'s storages: {@link: module:koi/dmpQueue/storages}
 *
 * @module koi/dmpQueue/calls
 */
...
export const getDmpQueue = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/dmpQueue/calls/serviceOverweight}, but with scale encoded args.
         *
