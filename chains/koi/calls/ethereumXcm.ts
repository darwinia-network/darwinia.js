 ...
 * 
 * `EthereumXcm`'s storages: {@link: module:koi/ethereumXcm/storages}
 *
 * @module koi/ethereumXcm/calls
 */
...
export const getEthereumXcm = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/ethereumXcm/calls/transact}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: koi/ethereumXcm/calls/transactThroughProxy}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/ethereumXcm/calls/suspendEthereumXcmExecution}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/ethereumXcm/calls/resumeEthereumXcmExecution}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
