 ...
 * 
 * `EVM`'s storages: {@link: module:koi/evm/storages}
 *
 * @module koi/evm/calls
 */
...
export const getEVM = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/evm/calls/withdraw}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: koi/evm/calls/call}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/evm/calls/create}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/evm/calls/create2}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
