 ...
 * 
 * `Preimage`'s storages: {@link: module:koi/preimage/storages}
 *
 * @module koi/preimage/calls
 */
...
export const getPreimage = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/preimage/calls/notePreimage}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: koi/preimage/calls/unnotePreimage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/preimage/calls/requestPreimage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/preimage/calls/unrequestPreimage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
