 ...
 * 
 * `Whitelist`'s storages: {@link: module:koi/whitelist/storages}
 *
 * @module koi/whitelist/calls
 */
...
export const getWhitelist = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/whitelist/calls/whitelistCall}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: koi/whitelist/calls/removeWhitelistedCall}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/whitelist/calls/dispatchWhitelistedCall}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/whitelist/calls/dispatchWhitelistedCallWithPreimage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
