 ...
 * 
 * `Session`'s storages: {@link: module:koi/session/storages}
 *
 * @module koi/session/calls
 */
...
export const getSession = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/session/calls/setKeys}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: koi/session/calls/purgeKeys}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
