 ...
 * 
 * `DarwiniaStaking`'s storages: {@link: module:koi/darwiniaStaking/storages}
 *
 * @module koi/darwiniaStaking/calls
 */
...
export const getDarwiniaStaking = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/darwiniaStaking/calls/stake}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: koi/darwiniaStaking/calls/unstake}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/darwiniaStaking/calls/collect}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/darwiniaStaking/calls/nominate}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/darwiniaStaking/calls/chill}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/darwiniaStaking/calls/payout}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/darwiniaStaking/calls/setRateLimit}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/darwiniaStaking/calls/setCollatorCount}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
