 ...
 * 
 * `AssetManager`'s storages: {@link: module:koi/assetManager/storages}
 *
 * @module koi/assetManager/calls
 */
...
export const getAssetManager = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/assetManager/calls/registerForeignAsset}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: koi/assetManager/calls/setAssetUnitsPerSecond}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/assetManager/calls/changeExistingAssetType}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/assetManager/calls/removeSupportedAsset}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/assetManager/calls/removeExistingAssetType}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/assetManager/calls/registerLocalAsset}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/assetManager/calls/destroyForeignAsset}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/assetManager/calls/destroyLocalAsset}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
