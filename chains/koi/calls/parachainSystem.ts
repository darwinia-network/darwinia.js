 ...
 * 
 * `ParachainSystem`'s storages: {@link: module:koi/parachainSystem/storages}
 *
 * @module koi/parachainSystem/calls
 */
...
export const getParachainSystem = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/parachainSystem/calls/setValidationData}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: koi/parachainSystem/calls/sudoSendUpwardMessage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/parachainSystem/calls/authorizeUpgrade}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/parachainSystem/calls/enactAuthorizedUpgrade}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
