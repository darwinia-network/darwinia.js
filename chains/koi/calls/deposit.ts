 ...
 * 
 * `Deposit`'s storages: {@link: module:koi/deposit/storages}
 *
 * @module koi/deposit/calls
 */
...
export const getDeposit = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/deposit/calls/lock}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: koi/deposit/calls/claim}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/deposit/calls/claimWithPenalty}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
