 ...
 * 
 * `Treasury`'s storages: {@link: module:koi/treasury/storages}
 *
 * @module koi/treasury/calls
 */
...
export const getTreasury = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: koi/treasury/calls/proposeSpend}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: koi/treasury/calls/rejectProposal}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/treasury/calls/approveProposal}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/treasury/calls/spend}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/treasury/calls/removeApproval}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
