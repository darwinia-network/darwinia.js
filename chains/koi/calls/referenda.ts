 ...
 * 
 * `Referenda`'s storages: {@link: module:koi/referenda/storages}
 *
 * @module koi/referenda/calls
 */
...
export const getReferenda = (dispatch: Dispatch, metadata: Metadata) => {
    return {
         ...
         * See [`Pallet::submit`].
         *
         * @param {unknown} _proposal_origin Enum<{0/system: Enum<{0/Root: , 1/Signed: [U8; 20], 2/None: }>, 13/TechnicalCommittee: Enum<{0/Members: (U32, U32), 1/Member: [U8; 20], 2/_Phantom: }>, 17/Origins: Enum<{0/WhitelistedCaller: , 1/GeneralAdmin: , 2/ReferendumCanceller: , 3/ReferendumKiller: , 4/MediumSpender: , 5/BigSpender: }>, 27/PolkadotXcm: Enum<{0/Xcm: {parents: U8, interior: Enum<{0/Here, 1/X1, 2/X2, 3/X3, 4/X4, 5/X5, 6/X6, 7/X7, 8/X8}>}, 1/Response: {parents: U8, interior: Enum<{0/Here, 1/X1, 2/X2, 3/X3, 4/X4, 5/X5, 6/X6, 7/X7, 8/X8}>}}>, 28/CumulusXcm: Enum<{0/Relay: , 1/SiblingParachain: U32}>, 29/EthereumXcm: Enum<{0/XcmEthereumTransaction: [U8; 20]}>, 34/Ethereum: Enum<{0/EthereumTransaction: [U8; 20]}>, 36/EthTxForwarder: Enum<{0/ForwardEth: [U8; 20]}>, 8/Void: Enum<{}>}>
        ...
        /**
         * Similar to {@link: koi/referenda/calls/submit}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: koi/referenda/calls/placeDecisionDeposit}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/referenda/calls/refundDecisionDeposit}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/referenda/calls/cancel}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/referenda/calls/kill}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/referenda/calls/nudgeReferendum}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/referenda/calls/oneFewerDeciding}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/referenda/calls/refundSubmissionDeposit}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: koi/referenda/calls/setMetadata}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
