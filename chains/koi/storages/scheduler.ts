 ...
 * 
 * `Scheduler`'s calls: {@link: module:koi/scheduler/calls}
 *
 * @module koi/scheduler/storages
 */
export const getScheduler = (getStorage: GetStorage) => {
    return {
         ...
         * @returns {Promise<string | null>} BoundedVec: Vec<Enum<{0/None: , 1/Some: {maybe_id: Enum<{0/None: , 1/Some: [U8; 32]}>, priority: U8, call: Enum<{0/Legacy: {hash: [U8; 32]}, 1/Inline: Vec<U8>, 2/Lookup: {hash: [U8; 32], len: U32}}>, maybe_periodic: Enum<{0/None: , 1/Some: (U32, U32)}>, origin: Enum<{0/system: Enum<{0/Root, 1/Signed, 2/None}>, 13/TechnicalCommittee: Enum<{0/Members, 1/Member, 2/_Phantom}>, 17/Origins: Enum<{0/WhitelistedCaller, 1/GeneralAdmin, 2/ReferendumCanceller, 3/ReferendumKiller, 4/MediumSpender, 5/BigSpender}>, 27/PolkadotXcm: Enum<{0/Xcm, 1/Response}>, 28/CumulusXcm: Enum<{0/Relay, 1/SiblingParachain}>, 29/EthereumXcm: Enum<{0/XcmEthereumTransaction}>, 34/Ethereum: Enum<{0/EthereumTransaction}>, 36/EthTxForwarder: Enum<{0/ForwardEth}>, 8/Void: Enum<{}>}>}}>>
         */
