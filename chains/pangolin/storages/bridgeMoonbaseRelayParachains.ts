...
export const getBridgeMoonbaseRelayParachains = (getStorage: GetStorage) => {
    return {
        ...
        bestParaHeads: async (param0: unknown): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseRelayParachains', 'BestParaHeads', param0);
        },
        ...
        importedParaHeads: async (param0: unknown, param1: unknown): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseRelayParachains', 'ImportedParaHeads', param0, param1);
        },
        ...
        importedParaHashes: async (param0: unknown, param1: unknown): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseRelayParachains', 'ImportedParaHashes', param0, param1);
        },
    };
};
