...
/**
 * This is the doc comment for pallet `BridgeMoonbaseParachain`'s storages.
 * 
 * `BridgeMoonbaseParachain`'s calls: {@link: module:pangolin/bridgeMoonbaseParachain/calls}
 *
 * @module pangolin/bridgeMoonbaseParachain/storages
 */
export const getBridgeMoonbaseParachain = (getStorage: GetStorage) => {
    return {
        ...
        palletOwner: async (): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseParachain', 'PalletOwner');
        },
        ...
        palletOperatingMode: async (): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseParachain', 'PalletOperatingMode');
        },
        ...
        parasInfo: async (param0: unknown): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseParachain', 'ParasInfo', param0);
        },
        ...
        importedParaHeads: async (param0: unknown, param1: unknown): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseParachain', 'ImportedParaHeads', param0, param1);
        },
        ...
        importedParaHashes: async (param0: unknown, param1: unknown): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseParachain', 'ImportedParaHashes', param0, param1);
        },
    };
};
