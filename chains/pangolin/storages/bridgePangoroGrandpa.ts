...
/**
 * This is the doc comment for pallet `BridgePangoroGrandpa`'s storages.
 * 
 * `BridgePangoroGrandpa`'s calls: {@link: module:pangolin/bridgePangoroGrandpa/calls}
 *
 * @module pangolin/bridgePangoroGrandpa/storages
 */
export const getBridgePangoroGrandpa = (getStorage: GetStorage) => {
    return {
        ...
        palletOperatingMode: async (): Promise<string | null> => {
            return await getStorage('BridgePangoroGrandpa', 'PalletOperatingMode');
        },
    };
};
