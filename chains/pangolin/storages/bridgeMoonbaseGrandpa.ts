...
/**
 * This is the doc comment for pallet `BridgeMoonbaseGrandpa`'s storages.
 * 
 * `BridgeMoonbaseGrandpa`'s calls: {@link: module:pangolin/bridgeMoonbaseGrandpa/calls}
 *
 * @module pangolin/bridgeMoonbaseGrandpa/storages
 */
export const getBridgeMoonbaseGrandpa = (getStorage: GetStorage) => {
    return {
        ...
        requestCount: async (): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseGrandpa', 'RequestCount');
        },
        ...
        initialHash: async (): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseGrandpa', 'InitialHash');
        },
        ...
        bestFinalized: async (): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseGrandpa', 'BestFinalized');
        },
        ...
        importedHashes: async (param0: unknown): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseGrandpa', 'ImportedHashes', param0);
        },
        ...
        importedHashesPointer: async (): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseGrandpa', 'ImportedHashesPointer');
        },
        ...
        importedHeaders: async (param0: unknown): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseGrandpa', 'ImportedHeaders', param0);
        },
        ...
        currentAuthoritySet: async (): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseGrandpa', 'CurrentAuthoritySet');
        },
        ...
        palletOwner: async (): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseGrandpa', 'PalletOwner');
        },
        ...
        palletOperatingMode: async (): Promise<string | null> => {
            return await getStorage('BridgeMoonbaseGrandpa', 'PalletOperatingMode');
        },
    };
};
