 ...
 * 
 * `ImOnline`'s storages: {@link: module:pangolin/imOnline/storages}
 *
 * @module pangolin/imOnline/calls
 */
...
export const getImOnline = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
	 * Similar to {@link: pangolin/imOnline/calls/heartbeat}, but with scale encoded args.
	 *
