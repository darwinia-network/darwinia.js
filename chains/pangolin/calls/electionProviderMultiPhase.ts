 ...
 * 
 * `ElectionProviderMultiPhase`'s storages: {@link: module:pangolin/electionProviderMultiPhase/storages}
 *
 * @module pangolin/electionProviderMultiPhase/calls
 */
...
export const getElectionProviderMultiPhase = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin/electionProviderMultiPhase/calls/submitUnsigned}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangolin/electionProviderMultiPhase/calls/setMinimumUntrustedScore}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin/electionProviderMultiPhase/calls/setEmergencyElectionResult}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin/electionProviderMultiPhase/calls/submit}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
