 ...
 * 
 * `DmpQueue`'s storages: {@link: module:pangolin/dmpQueue/storages}
 *
 * @module pangolin/dmpQueue/calls
 */
...
export const getDmpQueue = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin/dmpQueue/calls/serviceOverweight}, but with scale encoded args.
         *
