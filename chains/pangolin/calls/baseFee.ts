 ...
 * 
 * `BaseFee`'s storages: {@link: module:pangolin/baseFee/storages}
 *
...
export const getBaseFee = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin/baseFee/calls/setBaseFeePerGas}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangolin/baseFee/calls/setIsActive}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin/baseFee/calls/setElasticity}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
