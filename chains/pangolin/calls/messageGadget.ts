 ...
 * 
 * `MessageGadget`'s storages: {@link: module:pangolin/messageGadget/storages}
 *
 * @module pangolin/messageGadget/calls
 */
...
export const getMessageGadget = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
	 * Similar to {@link: pangolin/messageGadget/calls/setCommitmentContract}, but with scale encoded args.
	 *
