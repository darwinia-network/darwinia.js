 ...
 * 
 * `Preimage`'s storages: {@link: module:pangolin/preimage/storages}
 *
 * @module pangolin/preimage/calls
 */
...
export const getPreimage = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin/preimage/calls/notePreimage}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangolin/preimage/calls/unnotePreimage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin/preimage/calls/requestPreimage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin/preimage/calls/unrequestPreimage}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
