 ...
 * 
 * `Timestamp`'s storages: {@link: module:pangolin/timestamp/storages}
 *
 * @module pangolin/timestamp/calls
 */
...
export const getTimestamp = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin/timestamp/calls/set}, but with scale encoded args.
         *
