 ...
 * 
 * `Recovery`'s storages: {@link: module:pangolin/recovery/storages}
 *
 * @module pangolin/recovery/calls
 */
...
export const getRecovery = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin/recovery/calls/asRecovered}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        asRecoveredH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'asRecovered', true, argsBytes);
        },
         ...
         * @returns {CallAsParam} 
         */
        buildAsRecoveredCall: (_account: unknown, _call: unknown) => {
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildAsRecoveredCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        buildAsRecoveredCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'Recovery', 'asRecovered', argsBytes)
        },
        ...
        /**
         * Similar to {@link: pangolin/recovery/calls/setRecovered}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        setRecoveredH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'setRecovered', true, argsBytes);
        },
         ...
         * @returns {CallAsParam} 
         */
        buildSetRecoveredCall: (_lost: unknown, _rescuer: unknown) => {
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildSetRecoveredCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        buildSetRecoveredCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'Recovery', 'setRecovered', argsBytes)
        },
         ...
         * # </weight>
         *
         * @param {unknown} _friends Vec<[U8; 32]>
         * @param {unknown} _threshold U16
         * @param {unknown} _delay_period U32
         * @instance
         */
        createRecovery: async (signer: ethers.Signer, _friends: unknown, _threshold: unknown, _delay_period: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'createRecovery', false, {
                friends: _friends,
        ...
        /**
         * Similar to {@link: pangolin/recovery/calls/createRecovery}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        createRecoveryH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'createRecovery', true, argsBytes);
        },
         ...
         * @returns {CallAsParam} 
         */
        buildCreateRecoveryCall: (_friends: unknown, _threshold: unknown, _delay_period: unknown) => {
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildCreateRecoveryCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        buildCreateRecoveryCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'Recovery', 'createRecovery', argsBytes)
        },
        ...
        initiateRecovery: async (signer: ethers.Signer, _account: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'initiateRecovery', false, {
                account: _account,
           });
        },

        /**
         * Similar to {@link: pangolin/recovery/calls/initiateRecovery}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        initiateRecoveryH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'initiateRecovery', true, argsBytes);
        },
         ...
         * @returns {CallAsParam} 
         */
        buildInitiateRecoveryCall: (_account: unknown) => {
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildInitiateRecoveryCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        buildInitiateRecoveryCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'Recovery', 'initiateRecovery', argsBytes)
        },
        ...
        vouchRecovery: async (signer: ethers.Signer, _lost: unknown, _rescuer: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'vouchRecovery', false, {
                lost: _lost,
                rescuer: _rescuer,
           });
        },
        ...
        /**
         * Similar to {@link: pangolin/recovery/calls/vouchRecovery}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        vouchRecoveryH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'vouchRecovery', true, argsBytes);
        },
         ...
         * @returns {CallAsParam} 
         */
        buildVouchRecoveryCall: (_lost: unknown, _rescuer: unknown) => {
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildVouchRecoveryCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        buildVouchRecoveryCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'Recovery', 'vouchRecovery', argsBytes)
        },
        ...
        claimRecovery: async (signer: ethers.Signer, _account: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'claimRecovery', false, {
                account: _account,
           });
        },

        /**
         * Similar to {@link: pangolin/recovery/calls/claimRecovery}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        claimRecoveryH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'claimRecovery', true, argsBytes);
        },
         ...
         * @returns {CallAsParam} 
         */
        buildClaimRecoveryCall: (_account: unknown) => {
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildClaimRecoveryCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        buildClaimRecoveryCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'Recovery', 'claimRecovery', argsBytes)
        },
        ...
        closeRecovery: async (signer: ethers.Signer, _rescuer: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'closeRecovery', false, {
                rescuer: _rescuer,
           });
        },

        /**
         * Similar to {@link: pangolin/recovery/calls/closeRecovery}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        closeRecoveryH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'closeRecovery', true, argsBytes);
        },
         ...
         * @returns {CallAsParam} 
         */
        buildCloseRecoveryCall: (_rescuer: unknown) => {
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildCloseRecoveryCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        buildCloseRecoveryCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'Recovery', 'closeRecovery', argsBytes)
        },
        ...
        /**
         * Similar to {@link: pangolin/recovery/calls/removeRecovery}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        removeRecoveryH: async (signer: ethers.Signer): Promise<ethers.providers.TransactionReceipt> => {
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildRemoveRecoveryCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        buildRemoveRecoveryCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'Recovery', 'removeRecovery', argsBytes)
        },
        ...
        cancelRecovered: async (signer: ethers.Signer, _account: unknown): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'cancelRecovered', false, {
                account: _account,
           });
        },

        /**
         * Similar to {@link: pangolin/recovery/calls/cancelRecovered}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        cancelRecoveredH: async (signer: ethers.Signer, argsBytes: BytesLike): Promise<ethers.providers.TransactionReceipt> => {
            return await dispatch(signer, 'Recovery', 'cancelRecovered', true, argsBytes);
        },
         ...
         * @returns {CallAsParam} 
         */
        buildCancelRecoveredCall: (_account: unknown) => {
        ...
        /**
         * Build a call object to be used as a call param in other functions, such as `utilities.batchAll`.
         * Similar to buildCancelRecoveredCall, but with scale encoded args.
         *
         * @returns {CallAsParam} 
         */
        buildCancelRecoveredCallH: (argsBytes: BytesLike) => {
            return decodeCall(metadata, 'Recovery', 'cancelRecovered', argsBytes)
        },
