 ...
 * 
 * `AccountMigration`'s storages: {@link: module:pangolin/accountMigration/storages}
 *
 * @module pangolin/accountMigration/calls
 */
...
export const getAccountMigration = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin/accountMigration/calls/migrate}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangolin/accountMigration/calls/migrateMultisig}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin/accountMigration/calls/completeMultisigMigration}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
