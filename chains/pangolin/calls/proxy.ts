...
export const getProxy = (dispatch: Dispatch, metadata: Metadata) => {
    return {
         ...
         * @param {unknown} _force_proxy_type Enum<{0/None: , 1/Some: Enum<{0/Any: , 1/NonTransfer: , 2/Governance: , 3/Staking: , 4/EthereumBridge: }>}>
	 ...
	 */
         ...
         * @param {unknown} _proxy_type Enum<{0/Any: , 1/NonTransfer: , 2/Governance: , 3/Staking: , 4/EthereumBridge: }>
	 ...
	 */
        ...
        /**
	 * Similar to {@link: pangolin/proxy/calls/anonymous}, but with scale encoded args.
	 *
	 * @param {BytesLike} argsBytes the args bytes
	 */
	 ...
	 */
        ...
        /**
	 * Similar to {@link: pangolin/proxy/calls/killAnonymous}, but with scale encoded args.
	 *
	 * @param {BytesLike} argsBytes the args bytes
	 */
