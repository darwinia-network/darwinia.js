 ...
 * 
 * `Deposit`'s storages: {@link: module:pangolin/deposit/storages}
 *
 * @module pangolin/deposit/calls
 */
...
export const getDeposit = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin/deposit/calls/lock}, but with scale encoded args.
         *
        ...
        /**
         * Similar to {@link: pangolin/deposit/calls/claim}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
        ...
        /**
         * Similar to {@link: pangolin/deposit/calls/claimWithPenalty}, but with scale encoded args.
         *
         * @param {BytesLike} argsBytes the args bytes
         * @instance
         */
