 ...
 * 
 * `AssetLimit`'s storages: {@link: module:pangolin/assetLimit/storages}
 *
 * @module pangolin/assetLimit/calls
 */
...
export const getAssetLimit = (dispatch: Dispatch, metadata: Metadata) => {
    return {
        ...
        /**
         * Similar to {@link: pangolin/assetLimit/calls/setForeignAssetLimit}, but with scale encoded args.
         *
